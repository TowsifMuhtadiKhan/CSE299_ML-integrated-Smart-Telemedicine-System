 <?php include('add_doctor_process.php');?>
 <!DOCTYPE html>
<html>
<head>
	<title>VHSBD</title>
...
<body>
	...
	<div class="mainbody">
		<div class="box">
		    <p class="account">Fill Up the Form with Doctor's Information</p>
	    ...
	    <div class="Container">
         ...
         <div class="Wrapeer2">
            ...
            <div class="Wrapeer3">
	        <div>	
	    	<button type = "submit" class="button" name = "add_doc">Add Doctor</button>
	    	</div>
	        </div>
