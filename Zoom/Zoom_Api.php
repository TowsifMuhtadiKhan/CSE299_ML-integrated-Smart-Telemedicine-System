...
class Zoom_Api
{
	private $zoom_api_key = 'BgXKmEfbRi-C32le91qNCQ';
	private $zoom_api_secret = 'atH2HRuFQVMb7wQj8AkfD8ivtrs7BonWzykL';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/towsifkhan98@gmail.com/meetings";
